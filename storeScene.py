...
class DCInputChangesConfirm(BaseStore):
    ...
    def organizeContent(self):
        ...
        self.materialLineNum = int(self.oldFile[2])
        
        self.newFile = []
        self.newFile.extend(self.oldFile[0:2])

        self.newFile.append('%d\n%d\n%d\n%d\n%d\n%d'%(len(df_inputDatabase.materialLines)+self.materialLineNum  \
    ...
    def __addLines(self):
        ...
        self.newFile.extend(self.oldFile[8+self.jointLinesNum:8+self.jointLinesNum+self.materialLineNum])
