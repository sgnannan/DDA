...
#        FreeCAD.Console.PrintMessage('Loading DDA GUI...\n')
        ...
        import DDAGui
        list = ['DDA_NewDoc' , 'DDA_Undo' , 'DDA_Redo',  'Std_ViewFitAll' , 'DDA_ChooseProjectPath' , 'DDA_DL' , 'DDA_DC','DFCalculation','PlayDF', 'DDA_DGAnalysiser' , 'DDA_Examples']
...
#        Base.__currentProjectPath__ = str(settings.value('ProjectPath' , None).toString())
        Base.__currentProjectPath__ = str(settings.value('ProjectPath' , None))
        import PyDDA,DDAGui
        PyDDA.setCurrentProjectPath(Base.__currentProjectPath__)
