2014.3.15 添加了选择是否计算时实时显示的选项，并在计算时输出分析所需数据
2014.3.14 修正了DF两次导入数据后，已设置材料消失的问题
		      修正了再次导入DF后，材料线bug的问题。

2014.3.13 全新设计了DF参数输入界面

2014.3.10 添加DF边计算边显示功能

2014.2.19
解决不能占选物体的bug，原因：soseparator.removeAllChildren()将处理event callback的结点也给删除掉了

2014.2.18  设定easyDDA启动workbench为DDA
