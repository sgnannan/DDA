...
class DFParameters:
    ...
    def reset(self):
        ...
        self.SOR = 0
        self.ifRightHand = 1
        self.waterUnitWeight = 1
        self.sectionAngle = 1
        self.gravityAcceleration = 0
        self.earthquakeTimeInterval = 0
        
        self.blockMats = []
        self.jointMats = []
        self.loadingPointMats = []
        self.waterControlPoints = []
        self.earthquakePoints = []
...
class OperationObverser:
    ...
    def Activated(self, name="None"):
        ...
        import Base
        Base.delaycommand(self.__addEventCallback)
        
    def __addEventCallback(self):
